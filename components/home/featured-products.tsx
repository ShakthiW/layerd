        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {products.map((product, i) => (
            ...
            >
              ...
              <div
                className={`relative mb-4 aspect-square overflow-hidden rounded-2xl border border-white/6 bg-linear-to-br ${product.color} transition-all duration-700 group-hover:border-warm-gold/20 group-hover:shadow-lg`}
              >
